...
public class CatalogActivity extends AppCompatActivity {
    ...
    private void displayDatabaseInfo() {
        ...
        String selection = null; //PetEntry.COLUMN_PET_GENDER + "=? AND " + PetEntry.COLUMN_PET_WEIGHT + "=?";
        String[] selectionArgs = null; //{"2", "45"};
        ...
        try {
            ...
            while(cursor.moveToNext()) {
                ...
                int genderInt = cursor.getInt(genderIndex);
                String gender;
                switch(genderInt) {
